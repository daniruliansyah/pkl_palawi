    ...
    public function run(): void
    {
        ...
        $sppds = [
            [
                ...
                'keterangan_sppd'    => 'Perjalanan dinas ke Surabaya untuk rapat kerja',
                'lokasi_tujuan' => 'Banyuwangi',
                'lokasi_berangkat' => 'Surabaya',
                'status'    => 'menunggu',
                'pemberi_tugas' => 'Senior Analis Keuangan, SDM & Umum',
                'nip_penyetuju'  => $userSDM->nip,
                'tgl_persetujuan' => Carbon::now(),
                'alat_angkat' => 'bis kencang',
                'jumlah_hari' => 12,
                'no_rekening' => '1234567890',
                'nama_rekening' => 'PT. Palawi',
                'keterangan_lain' => 'Bawa oleh-oleh',
            ],
