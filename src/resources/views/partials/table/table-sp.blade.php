...
<div class="flex items-center justify-center p-4">
    <div class="w-full max-w-2xl rounded-2xl bg-white p-8 shadow-md">
        ...
        <form action="{{ route('sp.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                <label for="file_sp" class="mb-1 block text-sm font-medium text-gray-700">Upload Surat Peringatan (Opsional)</label>
...
<script>
    $(document).ready(function() {
        $('#nip_user').select2({
            ...
            allowClear: true,
            // Tambahkan kelas Tailwind pada container utama Select2
            ...
            // Tambahkan kelas Tailwind pada dropdown Select2
