        ...
        <ul class="mb-6 flex flex-col gap-4">
          ...
          <li>
            ...
            <div class="overflow-hidden" :class="(selected === 'Dashboard') ? 'block' : 'hidden'">
              <ul class="mt-2 flex flex-col gap-1 pl-9" :class="sidebarToggle ? 'lg:hidden' : ''">
                <li>
                  <a href="index.html" class="menu-dropdown-item group" :class="page === 'ecommerce' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">eCommerce</a>
                </li>
              </ul>
            </div>
          </li>
          <!-- end Dashboard > ecommerce -->
          ...
          <!-- User Profile -->
          <li>
             <a href="#.html" class="menu-item group" :class="(page === 'profile') ? 'menu-item-active' : 'menu-item-inactive'">
                <svg
