...
<body>
    ...
    <div class="container">
        <h1>Verifikasi Surat Perjalanan Dinas</h1>
        ...
        <div style="margin-top: 30px;">
            ...
            <div class="info-item">
                ...
                <span class="value">Surat Perjalanan Dinas</span>
            </div>

            {{-- 2. Nomor Surat --}}
            <div class="info-item">
                <span class="label">Nomor Surat</span>
                <span class="value">{{ $sppd->no_surat ?? 'BELUM DITERBITKAN' }}</span>
            </div>
            ...
            <div class="info-item">
                ...
                <span class="value">
                    {{ $sppd->tgl_persetujuan ? \Carbon\Carbon::parse($sppd->tgl_persetujuan)->isoFormat('D MMMM YYYY') : '-' }}
                </span>
            </div>

            {{-- 4. Maksud Perjalanan Dinas --}}
            <div class="info-item">
                <span class="label">Maksud Perjalanan</span>
                <span class="value">{{ $sppd->keterangan_sppd }}</span>
            </div>

            {{-- 5. Yang Melakukan Perjalanan --}}
            <div class="info-item">
                <span class="label">Pelaksana Tugas</span>
                <span class="value">{{ $sppd->user->nama_lengkap ?? 'Data Karyawan Tidak Ditemukan' }}</span>
            </div>
            ...
            <div class="info-item">
                ...
                <span class="value">
                    @php
                        ...
                        $penyetuju = \App\Models\User::where('nip', $sppd->nip_penyetuju)->first();
                    @endphp
            ...
            <div class="info-item">
                <span class="label">Tujuan (Berangkat - Tiba)</span>
                <span class="value">{{ $sppd->lokasi_berangkat }} - {{ $sppd->lokasi_tujuan }}</span>
            </div>
        </div>
    </div>
