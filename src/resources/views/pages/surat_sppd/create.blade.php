  ...
  <div class="w-full max-w-2xl bg-white rounded-2xl shadow p-8">
      ...
      <form action="{{ route('sppd.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
          ...
          <div>
              ...
              @error('tgl_mulai') <p class="text-red-500 text-xs">{{ $message }}</p> @enderror
          </div>
          ...
          <div>
              ...
              @error('tgl_selesai') <p class="text-red-500 text-xs">{{ $message }}</p> @enderror
          </div>
          ...
          <div>
              ...
              <textarea name="keterangan" id="keterangan" rows="3"
                        class="mt-1 block w-full rounded-lg border border-gray-300 py-2.5 px-4
                               shadow-sm text-sm focus:border-green-400 focus:ring-2 focus:ring-green-100">{{ old('keterangan') }}</textarea>
          ...
          <div>
              ...
              <input type="text" name="lokasi_tujuan" id="lokasi_tujuan" value="{{ old('lokasi_tujuan') }}"
                     class="mt-1 block w-full rounded-lg border border-gray-300 py-2.5 px-4
                            shadow-sm text-sm focus:border-green-400 focus:ring-2 focus:ring-green-100">
              @error('lokasi_tujuan') <p class="text-red-500 text-xs">{{ $message }}</p> @enderror
          </div>
          ...
          <div>
              ...
              @error('surat_bukti') <p class="text-red-500 text-xs">{{ $message }}</p> @enderror
          </div>
