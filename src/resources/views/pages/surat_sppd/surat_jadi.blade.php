        ...
        <table class="no-border" style="margin-top: 50px;">
            <tr>
                <td style="text-align: center; width: 45%;">
                    ...
                    <p>General Manager</p>
                    <img
                        src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/barcode_gm.png'))) }}"
                        alt="Tanda Tangan GM"
                ...
                <td style="text-align: center; width: 45%;">
                    ...
                    <img
                        src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/barcode_sdm.png'))) }}"
                        alt="Tanda Tangan SDM"
                        class="signature-image"
                    >
