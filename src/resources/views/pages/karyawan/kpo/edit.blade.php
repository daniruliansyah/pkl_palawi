...
@section('title', 'Edit Riwayat KPO - ' . $karyawan->nama_lengkap)

@section('content')
<div class="flex items-center justify-center p-4">
    <div class="w-full max-w-2xl rounded-2xl bg-white p-8 shadow-md dark:bg-gray-800">
        <h2 class="mb-6 text-2xl font-bold text-gray-800 dark:text-white">Formulir Edit Riwayat KPO</h2>
        <p class="mb-6 text-sm text-gray-600 dark:text-gray-400">Mengedit riwayat KPO untuk karyawan: <strong class="text-gray-900 dark:text-white">{{ $karyawan->nama_lengkap }}</strong></p>
        ...
        {{-- UPDATE ROUTE: kpo.update --}}
        <form action="{{ route('kpo.update', $kpo->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="nama_jabatan" id="nama_jabatan" value="{{ old('nama_jabatan', $kpo->nama_jabatan) }}" required placeholder="Contoh: Kepala Bagian SDM"
            ...
            <div>
                ...
                <input type="text" name="nama_organisasi" id="nama_organisasi" value="{{ old('nama_organisasi', $kpo->nama_organisasi) }}" required placeholder="Contoh: PT Palawi Risorsis"
                       class="mt-1 block w-full rounded-lg border border-gray-300 py-2.5 px-4 text-sm focus:border-green-400 focus:ring-2 focus:ring-green-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
            ...
            <div>
                ...
                <input type="date" name="tgl_jabat" id="tgl_jabat" value="{{ old('tgl_jabat', $kpo->tgl_jabat) }}" required
                       class="mt-1 block w-full rounded-lg border border-gray-300 py-2.5 px-4 text-sm focus:border-green-400 focus:ring-2 focus:ring-green-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
            ...
            <div>
                ...
                <input type="text" name="link_berkas" id="link_berkas" value="{{ old('link_berkas', $kpo->link_berkas) }}" placeholder="Link Google Drive / Penyimpanan"
                       class="mt-1 block w-full rounded-lg border border-gray-300 py-2.5 px-4 text-sm focus:border-green-400 focus:ring-2 focus:ring-green-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
