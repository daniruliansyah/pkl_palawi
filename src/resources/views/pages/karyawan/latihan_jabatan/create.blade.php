...
@section('title', 'Tambah Latihan Jabatan - ' . $karyawan->nama_lengkap)

@section('content')
<div class="flex items-center justify-center p-4">
    <div class="w-full max-w-2xl rounded-2xl bg-white p-8 shadow-md dark:bg-gray-800">
        <h2 class="mb-6 text-2xl font-bold text-gray-800 dark:text-white">Formulir Latihan Jabatan</h2>
        <p class="mb-6 text-sm text-gray-600 dark:text-gray-400">Menambahkan riwayat latihan/diklat untuk: <strong class="text-gray-900 dark:text-white">{{ $karyawan->nama_lengkap }}</strong></p>
        ...
        <form action="{{ route('karyawan.latihan-jabatan.store', $karyawan->id) }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="nama_latihan" id="nama_latihan" value="{{ old('nama_latihan') }}" required placeholder="Contoh: Pelatihan Kepemimpinan Tingkat I"
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div>
                    ...
                    <input type="date" name="tgl_mulai" id="tgl_mulai" value="{{ old('tgl_mulai') }}" required
                           class="mt-1 block w-full rounded-lg border border-gray-300 py-2.5 px-4 text-sm focus:border-green-400 focus:ring-2 focus:ring-green-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
            ...
            <div>
                ...
                <input type="text" name="link_berkas" id="link_berkas" value="{{ old('link_berkas') }}" placeholder="Link sertifikat / bukti pelatihan"
                       class="mt-1 block w-full rounded-lg border border-gray-300 py-2.5 px-4 text-sm focus:border-green-400 focus:ring-2 focus:ring-green-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
