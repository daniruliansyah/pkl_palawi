...
@section('title', 'Tambah Riwayat Penghargaan - ' . $karyawan->nama_lengkap)

@section('content')
<div class="flex items-center justify-center p-4">
    <div class="w-full max-w-2xl rounded-2xl bg-white p-8 shadow-md dark:bg-gray-800">
        <h2 class="mb-6 text-2xl font-bold text-gray-800 dark:text-white">Formulir Riwayat Penghargaan</h2>
        <p class="mb-6 text-sm text-gray-600 dark:text-gray-400">Menambahkan riwayat penghargaan untuk: <strong class="text-gray-900 dark:text-white">{{ $karyawan->nama_lengkap }}</strong></p>
        ...
        <form action="{{ route('karyawan.penghargaan.store', $karyawan->id) }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="nama_penghargaan" id="nama_penghargaan" value="{{ old('nama_penghargaan') }}" required placeholder="Contoh: Karyawan Teladan Tahun 2024"
            ...
            <div>
                ...
                <input type="date" name="tgl_terima" id="tgl_terima" value="{{ old('tgl_terima') }}" required
                       class="mt-1 block w-full rounded-lg border border-gray-300 py-2.5 px-4 text-sm focus:border-green-400 focus:ring-2 focus:ring-green-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
            ...
            <div>
                ...
                <input type="text" name="link_berkas" id="link_berkas" value="{{ old('link_berkas') }}" placeholder="Link bukti penghargaan"
                       class="mt-1 block w-full rounded-lg border border-gray-300 py-2.5 px-4 text-sm focus:border-green-400 focus:ring-2 focus:ring-green-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
