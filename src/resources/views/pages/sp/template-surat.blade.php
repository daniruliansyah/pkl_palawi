...
<head>
    ...
    <style>
        ...
        .logo-image { max-height: 70px; width: auto; } /* Ukuran logo disesuaikan */
        ...
        <table>
            <tr>
                <td class="logo-container">
                    {{-- PERBAIKAN 1: Menampilkan logo perusahaan, bukan QR Code --}}
                    @if($embed)
        ...
        <table>
            <tr>
                ...
                <td style="text-align: center;">
                    ...
                    <div class="qr-code">
                        {{-- PERBAIKAN 2: Menggunakan variabel $qrCodeDataUri --}}
