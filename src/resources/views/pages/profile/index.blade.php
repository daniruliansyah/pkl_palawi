...
@section('title', 'Karyawan - ' . $user->nama_lengkap)
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6">
            ...
            <div class="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                ...
                <div class="flex flex-col items-center w-full gap-6 xl:flex-row">
                    ...
                    <div class="order-3 xl:order-2">
                        ...
                        <div class="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                {{ $user->jabatanTerbaru?->jabatan?->nama_jabatan ?? '-' }}
                            </p>
                    ...
                    <div class="flex items-center order-2 gap-3 grow xl:order-3 xl:justify-end">
                        ...
                        <a href="{{ route('karyawan.cetakDetail', $user->id) }}"
                        ...
                        {{-- Tombol Riwayat Gaji --}}
                        <a href="{{ route('gaji.indexForKaryawan', $user->id) }}"
            ...
            <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                <div class="w-full">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="{{ route('profile.edit') }}" class="flex items-center justify-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                    ...
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                        <div><p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Nama Lengkap</p><p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->nama_lengkap }}</p></div>
                        <div><p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">NIK</p><p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->nik }}</p></div>
                        <div><p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Tanggal Lahir</p><p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->tgl_lahir }}</p></div>
                        <div><p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Tempat Lahir</p><p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->tempat_lahir }}</p></div>
                        <div><p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Jenis Kelamin</p><p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->jenis_kelamin == 1 ? 'Laki-laki' : 'Perempuan' }}</p></div>
                        <div><p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Agama</p><p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->agama }}</p></div>
                        <div><p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Email</p><p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->email }}</p></div>
                        <div><p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Nomor Telepon</p><p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->no_telp }}</p></div>
                        <div><p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Alamat</p><p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->alamat }}</p></div>
                        <div><p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Status Pernikahan</p><p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->status_perkawinan }}</p></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="w-full">
                  @if ($isUserSdm)
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="{{ route('karyawan.editkep', $user->id) }}" class="flex items-center justify-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                            <svg class="fill-current" width="16" height="16" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M15.0911 2.78206C14.2125 1.90338 12.7878 1.90338 11.9092 2.78206L4.57524 10.116C4.26682 10.4244 4.0547 10.8158 3.96468 11.2426L3.31231 14.3352C3.25997 14.5833 3.33653 14.841 3.51583 15.0203C3.69512 15.1996 3.95286 15.2761 4.20096 15.2238L7.29355 14.5714C7.72031 14.4814 8.11172 14.2693 8.42013 13.9609L15.7541 6.62695C16.6327 5.74827 16.6327 4.32365 15.7541 3.44497L15.0911 2.78206ZM12.9698 3.84272C13.2627 3.54982 13.7376 3.54982 14.0305 3.84272L14.6934 4.50563C14.9863 4.79852 14.9863 5.2734 14.6934 5.56629L14.044 6.21573L12.3204 4.49215L12.9698 3.84272ZM11.2597 5.55281L5.6359 11.1766C5.53309 11.2794 5.46238 11.4099 5.43238 11.5522L5.01758 13.5185L6.98394 13.1037C7.1262 13.0737 7.25666 13.003 7.35947 12.9002L12.9833 7.27639L11.2597 5.55281Z" fill="currentColor"></path>
                            </svg>
                            Edit
                  ...
                  @endif
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                        <div><p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">NPK</p><p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->npk_baru }}</p></div>
                        <div><p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">NPWP</p><p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->npwp }}</p></div>
                        <div><p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Jabatan</p><p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->jabatanTerbaru?->jabatan?->nama_jabatan ?? '-' }}</p></div>
                        <div><p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Area Kerja</p><p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->jabatanTerbaru?->area_bekerja ?? '-' }}</p></div>
                        <div><p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Pangkat</p><p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->jabatanTerbaru?->jenjang ?? '-' }}</p></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="p-5 mb-6 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
            <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between mb-6">
                ...
                @if ($isUserSdm)
                <div>
                    <a href="{{ route('karyawan.tambahjabatan', $user->id) }}" class="flex w-full items-center justify-center gap-2 rounded-full bg-green-500 px-4 py-3 text-sm font-medium text-white shadow-theme-xs hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700 lg:inline-flex lg:w-auto">
            ...
            <div class="space-y-6">
                @forelse ($user->riwayatJabatans as $riwayat)
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-6 last:border-b-0 last:pb-0">
                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between">
                            ...
                            <div class="flex items-center space-x-3 flex-shrink-0">
                                {{-- Edit --}}
                                <a href="{{ route('riwayat.edit', ['karyawan' => $user->id, 'riwayat' => $riwayat->id]) }}" class="flex items-center justify-center gap-1 rounded-full border border-gray-300 bg-white px-3 py-1.5 text-xs font-medium text-gray-600 shadow-sm hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                                ...
                                {{-- Delete --}}
                                <form action="{{ route('riwayat.destroy', ['karyawan' => $user->id, 'riwayat' => $riwayat->id]) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus riwayat ini?');">
                                    @csrf @method('DELETE')
        ...
        <div class="p-5 mb-6 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
            <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between mb-6">
                ...
                @if ($isUserSdm)
                <div>
                    <a href="{{ route('karyawan.pendidikan.create', $user->id) }}" class="flex w-full items-center justify-center gap-2 rounded-full bg-green-500 px-4 py-3 text-sm font-medium text-white shadow-theme-xs hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700 lg:inline-flex lg:w-auto">
                        <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M15.75 9.75H9.75V15.75H8.25V9.75H2.25V8.25H8.25V2.25H9.75V8.25H15.75V9.75Z" fill="currentColor"/></svg>
                        Tambah
                    </a>
                </div>
            ...
            <div class="space-y-6">
                @forelse ($user->riwayatPendidikan->sortByDesc('tahun_lulus') as $pendidikan)
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-6 last:border-b-0 last:pb-0">
                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between">
                            <div class="mb-4 sm:mb-0">
                                <div class="flex items-center flex-wrap gap-2 mb-1">
        ...
        <div class="p-5 mb-6 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
            <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between mb-6">
                ...
                @if ($isUserSdm)
                <div>
                    <a href="{{ route('karyawan.kpo.create', $user->id) }}" class="flex w-full items-center justify-center gap-2 rounded-full bg-green-500 px-4 py-3 text-sm font-medium text-white shadow-theme-xs hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700 lg:inline-flex lg:w-auto">
                        <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M15.75 9.75H9.75V15.75H8.25V9.75H2.25V8.25H8.25V2.25H9.75V8.25H15.75V9.75Z" fill="currentColor"/></svg>
                        Tambah
                    </a>
                </div>
            ...
            <div class="space-y-6">
                @forelse ($user->riwayatKpo->sortByDesc('tgl_jabat') as $kpo)
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-6 last:border-b-0 last:pb-0">
                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between">
                            <div class="mb-4 sm:mb-0">
                                <div class="flex items-center flex-wrap gap-2 mb-1">
        ...
        <div class="p-5 mb-6 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
            <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between mb-6">
                ...
                @if ($isUserSdm)
                <div>
                    <a href="{{ route('karyawan.latihan-jabatan.create', $user->id) }}" class="flex w-full items-center justify-center gap-2 rounded-full bg-green-500 px-4 py-3 text-sm font-medium text-white shadow-theme-xs hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700 lg:inline-flex lg:w-auto">
                        <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M15.75 9.75H9.75V15.75H8.25V9.75H2.25V8.25H8.25V2.25H9.75V8.25H15.75V9.75Z" fill="currentColor"/></svg>
                        Tambah
                    </a>
                </div>
            ...
            <div class="space-y-6">
                @forelse ($user->riwayatLatihanJabatan->sortByDesc('tgl_mulai') as $latihan)
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-6 last:border-b-0 last:pb-0">
                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between">
                            <div class="mb-4 sm:mb-0">
                                <div class="flex items-center flex-wrap gap-2 mb-1">
        ...
        <div class="p-5 mb-6 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
            <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between mb-6">
                ...
                @if ($isUserSdm)
                <div>
                    <a href="{{ route('karyawan.pangkat.create', $user->id) }}" class="flex w-full items-center justify-center gap-2 rounded-full bg-green-500 px-4 py-3 text-sm font-medium text-white shadow-theme-xs hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700 lg:inline-flex lg:w-auto">
                        <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M15.75 9.75H9.75V15.75H8.25V9.75H2.25V8.25H8.25V2.25H9.75V8.25H15.75V9.75Z" fill="currentColor"/></svg>
                        Tambah
                    </a>
                </div>
            ...
            <div class="space-y-6">
                @forelse ($user->riwayatPangkatPerusahaan->sortByDesc('tmt_gol') as $pangkat)
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-6 last:border-b-0 last:pb-0">
                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between">
                            <div class="mb-4 sm:mb-0">
                                <div class="flex items-center flex-wrap gap-2 mb-1">
        ...
        <div class="p-5 mb-6 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
            <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between mb-6">
                ...
                @if ($isUserSdm)
                <div>
                    <a href="{{ route('karyawan.penghargaan.create', $user->id) }}" class="flex w-full items-center justify-center gap-2 rounded-full bg-green-500 px-4 py-3 text-sm font-medium text-white shadow-theme-xs hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700 lg:inline-flex lg:w-auto">
                        <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M15.75 9.75H9.75V15.75H8.25V9.75H2.25V8.25H8.25V2.25H9.75V8.25H15.75V9.75Z" fill="currentColor"/></svg>
                        Tambah
                    </a>
                </div>
            ...
            <div class="space-y-6">
                @forelse ($user->riwayatPenghargaan->sortByDesc('tgl_terima') as $penghargaan)
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-6 last:border-b-0 last:pb-0">
                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between">
                            <div class="mb-4 sm:mb-0">
                                <div class="flex items-center flex-wrap gap-2 mb-1">
