            ...
            <table class="min-w-full text-sm text-left">
                <thead>
                    <tr class="border-y border-gray-100 bg-gray-50 text-gray-600">
                        ...
                        {{-- BARU: Menambahkan kolom isi surat --}}
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($spsForApproval as $sp)
                        <tr class="hover:bg-gray-50">
                            ...
                            {{-- BARU: Menampilkan isi surat dengan truncate dan tooltip --}}
                    ...
                    @empty
                        {{-- DIUBAH: Colspan diubah dari 6 menjadi 7 --}}
                        <tr><td colspan="7" class="py-8 text-center text-gray-500">Tidak ada Surat Peringatan yang menunggu persetujuan Anda.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
