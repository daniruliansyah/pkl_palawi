...
@section('title', 'Edit Riwayat Pendidikan - ' . $karyawan->nama_lengkap)

@section('content')
<div class="flex items-center justify-center p-4">
    <div class="w-full max-w-2xl rounded-2xl bg-white p-8 shadow-md dark:bg-gray-800">
        <h2 class="mb-6 text-2xl font-bold text-gray-800 dark:text-white">Formulir Edit Riwayat Pendidikan</h2>
        <p class="mb-6 text-sm text-gray-600 dark:text-gray-400">Mengedit riwayat pendidikan untuk karyawan: <strong class="text-gray-900 dark:text-white">{{ $karyawan->nama_lengkap }}</strong> (NIP: {{ $karyawan->nip }})</p>
        ...
        {{-- Form action menunjuk ke route update dengan parameter pendidikan --}}
        <form action="{{ route('pendidikan.update', $pendidikan->id) }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="jenjang" id="jenjang" value="{{ old('jenjang', $pendidikan->jenjang) }}" required placeholder="Contoh: SMA, S1, S2"
            ...
            <div>
                ...
                <input type="text" name="nama_institusi" id="nama_institusi" value="{{ old('nama_institusi', $pendidikan->nama_institusi) }}" required placeholder="Nama lengkap sekolah atau universitas"
                       class="mt-1 block w-full rounded-lg border border-gray-300 py-2.5 px-4 text-sm focus:border-green-400 focus:ring-2 focus:ring-green-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
            ...
            <div>
                ...
                <input type="text" name="jurusan" id="jurusan" value="{{ old('jurusan', $pendidikan->jurusan) }}" placeholder="Kosongkan jika tidak relevan (misal: SD/SMP/SMA)"
                       class="mt-1 block w-full rounded-lg border border-gray-300 py-2.5 px-4 text-sm focus:border-green-400 focus:ring-2 focus:ring-green-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div>
                    ...
                    <input type="number" name="tahun_masuk" id="tahun_masuk" value="{{ old('tahun_masuk', $pendidikan->tahun_masuk) }}" required placeholder="YYYY" min="1900" max="{{ date('Y') }}"
                           class="mt-1 block w-full rounded-lg border border-gray-300 py-2.5 px-4 text-sm focus:border-green-400 focus:ring-2 focus:ring-green-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
                ...
                <div>
                    ...
                    <input type="number" name="tahun_lulus" id="tahun_lulus" value="{{ old('tahun_lulus', $pendidikan->tahun_lulus) }}" required placeholder="YYYY" min="1900" max="{{ date('Y') + 5 }}" {{-- Maksimal 5 tahun ke depan --}}
                           class="mt-1 block w-full rounded-lg border border-gray-300 py-2.5 px-4 text-sm focus:border-green-400 focus:ring-2 focus:ring-green-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
            ...
            <div>
                ...
                <input type="number" step="0.01" name="ipk" id="ipk" value="{{ old('ipk', $pendidikan->ipk) }}" placeholder="Contoh: 3.75 (kosongkan jika tidak relevan)" min="0" max="4.00"
                       class="mt-1 block w-full rounded-lg border border-gray-300 py-2.5 px-4 text-sm focus:border-green-400 focus:ring-2 focus:ring-green-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400">
